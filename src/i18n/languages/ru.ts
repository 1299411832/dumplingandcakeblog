...
export const ru: Translation = {
	...
	[Key.friendsTombstone]:
		"🪵 Надгробия дружеских ссылок · Та, что была, не вернётся",
	[Key.friendsTombstoneDesc]:
		"Эти ссылки были вручную сняты после долгой недоступности, закрытия сайта, потери взаимности или более года без обновлений. Если сайт вернётся — свяжитесь с нами для восстановления.",
