...
export const en: Translation = {
	...
	[Key.changelogFix]: "Bug Fix",
	[Key.changelogRemoval]: "Removal",
	[Key.changelogNoData]: "No updates yet",
	[Key.music]: "Music",
	...
	[Key.friendsTombstone]:
		"🪵 Friend Link Tombstones · Those who once walked beside us",
	[Key.friendsTombstoneDesc]:
		"These links were manually retired after being unreachable for a long time, shut down, losing reciprocal links, or dormant for over a year. If a site returns, feel free to contact us to restore it.",
	[Key.circle]: "Circle",
