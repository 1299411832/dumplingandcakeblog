...
export const zh_TW: Translation = {
	...
	[Key.changelogSubtitle]: "記錄部落格項目的功能迭代、問題修復與重要變更",
	[Key.changelogAll]: "全部",
	...
	[Key.friendsLatestTitle]: "✨ 新朋友 · 最近加入的夥伴們！",
	[Key.friendsMyFriendsTitle]: "🤪 好盆友 · 有些人呀，天天到處轉！",
	[Key.friendsMoreTitle]: "🤤 友情鏈結 · 那些人，那些事兒~",
	...
	[Key.circleFriends]: "友鏈總數",
	[Key.circleActive]: "活躍友鏈",
	[Key.circleLost]: "失聯友鏈",
	[Key.circleArticles]: "文章總數",
	[Key.circleLastUpdated]: "最近更新",
	[Key.circleNoData]: "暫無文章數據",
	[Key.circleLoading]: "正在載入朋友圈數據...",
