...
tags:
  ...
  - 使用文档
category: 博客指南
description: "博客的说说和足迹后台现已支持直接上传图片到 CloudFlare ImgBed 图床，无需手动复制链接。支持多文件批量上传、自动查重复用，配置简单，四个环境变量即可搞定。"
---
...
- [CloudFlare-ImgBed + Telegram 图床 + PicGo + Obsidian 自动上传全流程教程](/posts/正式版-CloudFlare-ImgBed-博客教程/) — 本地写作场景的图床方案
