...
subcategory: movie
status: 2
image: https://img.tsh520.cn/file/blog/bangumi/星际穿越.jpg
score: 0
tags:
  - 冒险
  - 剧情
...
- `image` 字段指向 CDN 地址 `https://img.tsh520.cn/file/blog/bangumi/`
...
脚本下载的海报保存在 `scripts/img-anime/` 目录。需要手动上传到 CDN 的 `https://img.tsh520.cn/file/blog/bangumi/` 路径，文件名保持一致即可。

例如：
1. 脚本生成 `scripts/img-anime/星际穿越.jpg`
2. 上传到 CDN → `https://img.tsh520.cn/file/blog/bangumi/星际穿越.jpg`
